...
const getAllPaymentsByUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.body;
        const payments = yield prisma.payment.findMany({ where: { customerId: id }, include: { debt: true } });
        res.json({
            msg: 'ok',
            error: false,
...
const getPaymentById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingPayment = yield prisma.payment.findFirst({ where: { id: idNumber }, include: { debt: true } });
        if (!existingPayment)
